...
$stmt = $pdo->prepare("SELECT * FROM pages WHERE slug = 'reels-downloader' AND lang_code = 'en'");
$stmt->execute();
$dbPage = $stmt->fetch();
...
$t = [
    ...
    'heading' => $dbPage ? Translator::translate($dbPage['title'], $lang) : __("Download <span class='text-emerald-600 border-b-4 border-emerald-400/30'>Instagram Reels</span> in HD", $lang),
    'subtitle' => $dbPage ? Translator::translate(strip_tags($dbPage['content']), $lang) : __('Save your favorite Instagram Reels videos instantly to your device for free.', $lang),
    ...
    <header class="sticky top-0 z-50 backdrop-blur-md bg-white/50 border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center gap-8 font-semibold text-gray-500">
                <?php
                function renderHeaderMenu_reels($items, $pageIdentifier, $currentSlug, $depth = 0)
                {
                        ...
                        <div class="relative group">
                            ...
                            <?php if ($hasChildren): ?>
                                <div
                                    ...
                                    <?php renderHeaderMenu_reels($item['children'], $pageIdentifier, $currentSlug, $depth + 1); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach;
                }
                renderHeaderMenu_reels($headerItems, $pageIdentifier, '');
                ?>
            ...
            <div class="max-w-3xl mx-auto mb-20 fade-in">
                ...
                <div
                    ...
                    <a href="video.php?lang=<?php echo $lang; ?>"
                        class="px-6 py-3 rounded-[1.5rem] hover:bg-white/50 text-gray-700 transition-all">Video</a>
                    <a href="reels.php?lang=<?php echo $lang; ?>"
                        class="px-6 py-3 rounded-[1.5rem] bg-emerald-600 text-white shadow-lg transition-all">Reels</a>
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-gray-400">
                            ...
                            <li><a href="story.php?lang=<?php echo $lang; ?>" class="hover:text-emerald-400">Story
                                    Downloader</a></li>
                            <li><a href="blog.php?lang=<?php echo $lang; ?>" class="hover:text-emerald-400">Blog</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <ul class="space-y-4 text-gray-400">
                                    <?php foreach ($item['children'] as $child): ?>
                                        <li><a href="<?php echo htmlspecialchars($child['final_url']); ?>"
                                                class="hover:text-emerald-400"><?php echo htmlspecialchars($child['label']); ?></a>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            <?php endif; ?>
