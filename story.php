...
$t = [
    ...
    'heading' => $dbPage ? Translator::translate($dbPage['title'], $lang) : __("Anonymous <span class='text-emerald-600 border-b-4 border-emerald-400/30'>Story Downloader</span>", $lang),
    'subtitle' => $dbPage ? Translator::translate(strip_tags($dbPage['content']), $lang) : __('Watch and download Instagram Stories anonymously without leaving a trace.', $lang),
...
<body class="flex flex-col">
    ...
    <header class="sticky top-0 z-50 backdrop-blur-md bg-white/50 border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center gap-8 font-semibold text-gray-500">
                <?php
                function renderHeaderMenu_story($items, $pageIdentifier, $currentSlug, $depth = 0)
                {
                    foreach ($items as $item):
                        $isActive = (strpos($item['final_url'], 'story.php') !== false);
                        ...
                        <div class="relative group">
                            ...
                            <?php if ($hasChildren): ?>
                                <div
                                    ...
                                    <?php renderHeaderMenu_story($item['children'], $pageIdentifier, $currentSlug, $depth + 1); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach;
                }
                renderHeaderMenu_story($headerItems, $pageIdentifier, '');
                ?>
        ...
        <div class="max-w-3xl mx-auto mb-20 fade-in">
            ...
            <div
                ...
                <a href="story.php?lang=<?php echo $lang; ?>"
                    class="px-6 py-3 rounded-[1.5rem] bg-emerald-600 text-white shadow-lg transition-all">Story</a>
    ...
    <style>
        .article-content h2 { font-size: 2.25rem; font-weight: 900; color: #111827; margin-top: 3rem; margin-bottom: 1.5rem; letter-spacing: -0.025em; }
