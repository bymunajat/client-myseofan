    ...
    <main class="flex-1 min-h-screen bg-[#0f172a]">
        <header
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-0.5">Upload and manage images and files</p>
            </div>
        </header>
                        ...
                        <div class="p-3">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="javascript:void(0);"
                                    onclick="confirmDelete('?delete=<?php echo urlencode($f); ?>', 'This file will be permanently deleted from the server.')"
