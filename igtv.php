...
$defaults = [
    'en' => [
        ...
        'hero_title' => 'Instagram IGTV Downloader',
        'subtitle' => 'Download long-form IGTV videos from Instagram in HD.',
        'placeholder' => 'Paste IGTV video URL here',
        'btn_download' => 'Download',
        'btn_paste' => 'Paste',
        'intro_title' => 'Save IGTV Videos Easily',
        'intro_desc' => 'IGTV videos can be up to an hour long. MySeoFan makes it easy to download these larger files to your device so you can watch your favorite series, interviews, and vlogs offline.',
        'how_to_title' => 'How to download IGTV from Instagram?',
        'how_to_subtitle' => 'Follow these simple steps to save IGTV videos.',
        'step1_title' => 'Copy IGTV Link',
        'step1_desc' => 'Navigate to the IGTV video and copy its URL from the options menu.',
        'step2_title' => 'Paste Link',
        'step2_desc' => 'Paste the link into the box above and click the Download button.',
        'step3_title' => 'Save Video',
        'step3_desc' => 'Once processed, click Download to save the MP4 file.',
        'features_title' => 'Why choose our IGTV Downloader?',
        'features_subtitle' => 'Optimized for handling large video files efficiently.',
        'feat1_t' => 'Long Videos',
        'feat1_d' => 'Supports downloading videos of any length.',
        'feat2_t' => 'High Definition',
        'feat2_d' => 'Downloads in up to 1080p resolution.',
        'feat3_t' => 'Fast Speed',
        'feat3_d' => 'High-speed servers for quick downloads.',
        'feat4_t' => 'No Limits',
        'feat4_d' => 'Your activity is private and secure.',
        ...
        'faq_q1' => 'Are there length limits?',
        'faq_a1' => 'No, you can download IGTV videos of any length.',
        'faq_q2' => 'Do I need a login?',
        'faq_a2' => 'No login required for public IGTV videos.',
        'faq_q3' => 'Is it free?',
        'faq_a3' => 'Yes, our service is completely free.',
        'faq_q4' => 'Where are videos saved?',
        'faq_a4' => 'Videos are saved to your device\'s default download folder.',
    ],
];
            ...
            <div class="intro-card animate-fade-up">
                <div class="intro-visual">
                    <div class="bg-white/20 backdrop-blur-md p-6 rounded-2xl border border-white/30 text-white">
                        <i data-lucide="tv" class="w-16 h-16"></i>
                    </div>
                </div>
            ...
            <section id="detailed-features" class="mt-32 animate-fade-up">
                <div class="feature-detail-card">
                    ...
                    <div class="flex items-center justify-center p-8 bg-slate-100 rounded-xl">
                        <img src="assets/images/igtv-feature.png" alt="IGTV Features"
